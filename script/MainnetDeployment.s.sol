...
contract ContractScript is Script {
    function run() external {
        ...
        CurveFactoryV3 deployedCurveFactory =
            new CurveFactoryV3(address(deployedAssimFactory), address(config), Mainnet.WETH);
    ...
    function _deployCadcUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
    ...
    function _deployEurocUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
        IOracle usdOracle = IOracle(Mainnet.CHAINLINK_USDC_USD);
    ...
    function _deployGbptUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
        IOracle usdOracle = IOracle(Mainnet.CHAINLINK_USDC_USD);
        IOracle bptOracle = IOracle(Mainnet.CHAINLINK_BPT_USD);

        CurveFactoryV3.CurveInfo memory gbptUsdcCurveInfo = CurveFactoryV3.CurveInfo(
            "dfx-gbpt-usdc-v3",
            "dfx-gbpt-usdc-v3",
            Mainnet.GBPT,
            Mainnet.USDC,
    ...
    function _deployGyenUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
        IOracle usdOracle = IOracle(Mainnet.CHAINLINK_USDC_USD);
    ...
    function _deployNzdsUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
        IOracle usdOracle = IOracle(Mainnet.CHAINLINK_USDC_USD);
        IOracle nzdOracle = IOracle(Mainnet.CHAINLINK_NZD_USD);

        CurveFactoryV3.CurveInfo memory nzdsUsdcCurveInfo = CurveFactoryV3.CurveInfo(
            "dfx-nzds-usdc-v3",
            "dfx-nzds-usdc-v3",
            Mainnet.NZDS,
            Mainnet.USDC,
    ...
    function _deployTrybUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
        IOracle usdOracle = IOracle(Mainnet.CHAINLINK_USDC_USD);
    ...
    function _deployXidrUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
        IOracle usdOracle = IOracle(Mainnet.CHAINLINK_USDC_USD);
        IOracle idrOracle = IOracle(Mainnet.CHAINLINK_IDR_USD);

        CurveFactoryV3.CurveInfo memory xidrUsdcCurveInfo = CurveFactoryV3.CurveInfo(
            "dfx-xidr-usdc-v3",
            "dfx-xidr-usdc-v3",
            Mainnet.XIDR,
            Mainnet.USDC,
    ...
    function _deployXsgdUsdcCurve(CurveFactoryV3 deployedCurveFactory) internal {
        IOracle usdOracle = IOracle(Mainnet.CHAINLINK_USDC_USD);
